...
EL::StatusCode RegionVarCalculator_lvlv::doCalculate(std::unordered_map<std::string, double>& RegionVars,
  ...
  else if ( regionName == "SR" )  {return EL::StatusCode(doAllCalculations(RegionVars,particles,met)  == EL::StatusCode::SUCCESS &&
							 doSRCalculations (RegionVars,particles,met)  == EL::StatusCode::SUCCESS);}

  else if ( regionName == "CR1L") {return EL::StatusCode(doAllCalculations(RegionVars,particles,met)  == EL::StatusCode::SUCCESS &&
							 doCR1LCalculations(RegionVars,particles,met) == EL::StatusCode::SUCCESS);}

  else if ( regionName == "CR0L") {return EL::StatusCode(doAllCalculations(RegionVars,particles,met)  == EL::StatusCode::SUCCESS &&
							 doCR0LCalculations(RegionVars,particles,met) == EL::StatusCode::SUCCESS);}
